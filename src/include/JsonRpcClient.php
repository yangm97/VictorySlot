...
class JsonRpcClient
{
	...
	/**
	 * @var string - Authorisation credentials
	 */
	private $auth;
	 ...
	 * @param $auth string - Authentication value for server
	 */
	...
	public function __call( $method, $args )
	{
		...
		$auth   = ( isset( $args[ 2 ] ) ) ? $args[ 2 ] : null;
		return $this->call( $method, $params, $id, $auth );
	}
	 ...
	 * @return string - JSON-RPC Response
	 */
	public function call( $method, $params = null, $id = null, $auth = null )
	{
		$request = json_encode( $this->prepare( $method, $params, $id, $auth ) );
	 ...
	 */
	public function prepare( $method, $params, $id, $auth = null )
	{
